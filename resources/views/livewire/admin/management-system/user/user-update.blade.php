<!-- Modal -->
<div wire:ignore.self class="modal fade" id="userModalUpdate" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary justify-content-center">
                <h5 class="modal-title" id="staticBackdropLabel">Update Peran Pengguna</h5>
            </div>
                          ...
                          <div class="card-body">
                             <form wire:submit.prevent="update">
                                ...
                                <div class="form-group">
                                   ...
                                   <select id="select_user_role" name="role" data-placeholder="" class="custom-select w-100  @error("role") is-invalid @enderror" wire:model="selectedrole">
